            ...
            <form action="{{ route('tarif.update', ['id'=>$edit->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input value="{{$edit->namalayanan}}" required placeholder="Angin / Angin Maksimum / Angin Minimum. dsb"
                            name="namalayanan" type="text"
                    ...
                    <div>
                        ...
                        <input value="{{$edit->jenislayanan}}" placeholder="Udara Permukaan / Maritim / Prakiraan"
                            name="jenislayanan" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="tarif">Tarif</label>
                        <input value="{{$edit->tarif}}" required placeholder="60000" name="tarif" type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="satuan">Satuan</label>
                        <input value="{{$edit->satuan}}" required placeholder="Tahun / Per Buku / Per Laporan" name="satuan"
                            type="text"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    </div>
                    <div>
