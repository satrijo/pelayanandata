<div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-t-lg">
    <img class="object-contain md:h-2/3 md:w-full " src="/images/20200701091906.jpg">
</div>
<marquee class="bg-blue-500 text-white md:rounded-b-lg h-7" behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="12">
